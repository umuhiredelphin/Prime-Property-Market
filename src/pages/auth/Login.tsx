      ...
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[3rem] overflow-hidden shadow-2xl shadow-neutral-900/5 border border-neutral-100">
        ...
        <div className="p-8 md:p-16">
          <div className="mb-12">
            ...
            <p className="text-neutral-500 font-medium">Sign in to manage your properties and messages.</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <Link to="/register" className="text-neutral-500 font-medium hover:text-neutral-900 transition-colors">
